 ...
 * Generated at: 2022-05-27 01:22:14 UTC
...
if(dtos != null){
      ...
      out.write("                       <td style=\"width:20\"><input type =\"checkbox\" id=\"allcheck\" name =\"check\" onclick=\"delAll()\"></td>\r\n");
      out.write("\t\t               <td>姓名</td>\r\n");
      out.write("\t\t               <td>密码</td>\r\n");
      out.write("\t\t               <td>性别</td>\r\n");
      out.write("\t\t               <td>爱好</td>\r\n");
...
if(line%2 == 0){ 
      ...
      out.write("\r\n");
      out.write("                       <td><input type =\"checkbox\" id= \"check\" name =\"check\" ></td>\t\r\n");
...
if(",".equals(sb.toString().substring(sb.toString().length()-1))){
      ...
      out.write("                       <td colspan=\"9\" ><input type = \"button\" name=\"deleteall\" value=\"一括删除\" onclick=\"del()\"></td>\r\n");
      out.write("                  </tr>\r\n");
      out.write("              </table>\r\n");
      out.write("            ");
}
