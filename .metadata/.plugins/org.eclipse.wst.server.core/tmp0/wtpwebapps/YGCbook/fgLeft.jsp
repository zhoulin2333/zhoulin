...
<table width="770" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <tr> 
    <td rowspan="2" width="152"><a href="${pageContext.request.contextPath}/FindBookTypeServlet"><img src="<%=request.getContextPath()%>/images/logo.gif" width="152" height="84" alt="云工厂网上书店" border="0"></a></td>
    <td>
        ...
        <tr>
          ...
          <td valign="bottom" height="53" width="65"> 
            ...
            <a href="${pageContext.request.contextPath}/ShowMyFavoriteServlet"><img src="${pageContext.request.contextPath}/images/dd-10.gif" width="27" height="25" alt="我的帐户"><br>
              <span class="wr1">我的收藏夹</span></a></div>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr> 
    <td valign="bottom" nowrap><a href="${pageContext.request.contextPath}/FindBookTypeServlet"><img src="<%=request.getContextPath()%>/images/daodu05.gif" width="116" height="31" alt="首页" border="0"></a><a href="<%=request.getContextPath() %>/FindBookTypeServlet"><img src="<%=request.getContextPath()%>/images/daodu08.gif" width="95" height="31" alt="云工厂书系" border="0"></a><a href="<%=request.getContextPath() %>/FindBookTypeServlet"><img src="<%=request.getContextPath()%>/images/daodu09.gif" width="81" height="31" alt="文化" border="0"></a>
    <% if(customer != null) {%>
  ...
  <tr><td valign="top"><br></td></tr><tr valign="top"> 
    <td width="170"> 
      ...
      <table width="150" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td>
            <div align="center" class="wr1"><font color="#68A3A1"><b>西安钟楼新华书店</b></font></div>
          </td>
        </tr>
        <tr>
		...
		<tr>
          <td>
            <div align="center" class="wr1"><font color="#68A3A1"><b>西安外文书店</b></font></div>
          </td>
        </tr>
        <tr>
		...
		<tr>
          <td>
            <div align="center" class="wr1"><font color="#68A3A1"><b>影音第一站</b></font></div>
          </td>
        </tr>
        <tr>
          <td height="1" bgcolor="#000000"><img src="images/point.gif" width="1" height="1"></td>
		...
		<tr>
          <td>
            <div align="center" class="wr1"><font color="#68A3A1"><b>西安解放路图书大厦</b></font></div>
          </td>
        </tr>
        <tr>
          <td height="1" bgcolor="#000000"><img src="<%=request.getContextPath()%>/images/point.gif" width="1" height="1"></td>
		...
		<tr>
          <td class="wr1">
            <div align="center"><font color="#68A3A1"><b>天德图书</b></font></div>
          </td>
        </tr>
        <tr>
          <td height="1" bgcolor="#000000"><img src="<%=request.getContextPath()%>/images/point.gif" width="1" height="1"></td>
		...
		<tr>
          <td>
            <div align="center" class="wr1"><font color="#68A3A1"><b>音乐天地图书</b></font></div>
          </td>
        </tr>
        <tr>
          <td height="1" bgcolor="#000000"><img src="<%=request.getContextPath()%>/images/point.gif" width="1" height="1"></td>
		...
		<tr>
          <td>
            <div align="center" class="wr1"><font color="#68A3A1"><b>西安晚报社书店</b></font></div>
          </td>
        </tr>
        <tr>
          <td height="1" bgcolor="#000000"><img src="<%=request.getContextPath()%>/images/point.gif" width="1" height="1"></td>
